...
<div class="card container-fluid">
    <div style="background-color: white;" class="row p-2">
    	<form method="POST" action="resetpasswiord.php">
    		...
    		<input type="text" name="eid" class="col-sm-6 mt-3">
    		<div class="col-sm-12 mt-2" align="center"><button type="submit" class="btn btn-primary" style="background-color: #FF4500; border-color: #ff4500;">Reset Password</button></div>
    	</form>
    </div>
</div>
