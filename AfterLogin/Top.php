    ...
    <div class="row p-3">
     	<div class="col-xl-6 col-lg-5 col-sm-12">
      	...
      	<div class="col-xl-6 col-lg-57 col-sm-12">
              ...
              <div class="dropdown">
                <button class="btn btn-danger dropdown-toggle search" type="button" id="menu1" data-toggle="dropdown">[NAME]
                </button>
                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                  <li role="presentation" class="menuiteml p-2"><a role="menuitem" tabindex="-1" href="#" class="p-2 menuitem"><i class="fa fa-sign-out"></i>&emsp;Sign Out</a></li>
                  <li role="presentation" class="menuiteml p-2"><a role="menuitem" tabindex="-1" href="#" class="p-2 menuitem"><i class="fa fa-key"></i>&emsp;Change Password</a></li>
