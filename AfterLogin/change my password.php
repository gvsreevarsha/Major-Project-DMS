    ...
    <div style="background-color: white;" class="row p-2">
    	<form method="post" action="changepwd.php">  
 			<div class="container row">
				...
				<input class="col-sm-8 mt-1 mb-1 p-2" type="text" name="Current Password" id="currpwd"  placeholder="Enter Present Password"/>
				<label class="col-sm-4 mt-1 mb-1 p-2"> New Password </label>  
				<input class="col-sm-8 mt-1 mb-1 p-2" type="text" name="New Password"  placeholder="Enter New Password,6-28 Characters length"/>
				<label class="col-sm-4 mt-1 mb-1 p-2"> Confirm New Password </label>        
				<input class="col-sm-8 mt-1 mb-1 p-2" type="text" name="Confirm New Password" &nbsp placeholder="Re-enter the new password"/> 
